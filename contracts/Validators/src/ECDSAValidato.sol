...
/**
 * @notice This contract is a simple ECDSA validator that checks the signature of a user operation.
 * It is from [zerodev](https://github.com/zerodevapp) and has been modified by PlentiFi.
 */
pragma solidity ^0.8.0;

import {ECDSA} from "solady/utils/ECDSA.sol";
import {IValidator} from "../../common/interfaces/IERC7579Modules.sol";
