...
import "../src/kernel/core/ValidationManager.sol";
...
contract PermissionTest is Test {
    ...
    function testEncode(bytes1 mode, bytes1 vtype, bytes20 vIdWithoutType, uint16 nonceKey, uint64 seqNonce) external view {
